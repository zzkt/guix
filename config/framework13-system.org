...
Using =linux-6.19= from nonguix (which includes =CONFIG_MT7921E= by default as of 6.7.2)
#+begin_src scheme
 (kernel linux-6.19)
 ;; (kernel linux-FWL13)
 #+end_src

testing [[https://community.frame.work/t/adaptive-backlight-management-abm/41055][Adaptive Backlight Management (ABM)]] along with various [[https://wiki.linuxaudio.org/wiki/system_configuration#do_i_really_need_a_real-time_kernel][linuxaudio]] settings
#+BEGIN_SRC scheme
