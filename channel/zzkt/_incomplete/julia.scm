...
(define-public julia-lts
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0cw9wx3s0wj5kypxa9rhwqjkf3mzsajg8y8dzgncazgsgvwz5mmv"))))
    (build-system gnu-build-system)
    (arguments
     `(#:test-target "test"
       #:modules ((ice-9 match)
...
(define-public julia-next
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0j3980qnzjs34cywd7c7nbak4vxwqspicjrxfp6gabaslbjwky8f"))))
    (build-system gnu-build-system)
    (arguments
     `(#:test-target "test"
       #:modules ((ice-9 match)
